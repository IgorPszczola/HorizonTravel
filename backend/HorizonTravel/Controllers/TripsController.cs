    ...
    public class TripsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] string? kraj, [FromQuery] string? sortujPoCenie)
        {
            ...
            var result = trips.Select(t => new
            {
                ...
                dostepneMiejsca = t.MaksymalnaLiczbaMiejsc - t.Bookings.Where(b => b.Status != "Anulowana").Sum(b => b.LiczbaUczestnikow),
                t.AktualnaCena,
                t.DataRozpoczecia,
                t.DataZakonczenia,
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            return Ok(new
            {
                ...
                dostepneMiejsca = trip.MaksymalnaLiczbaMiejsc - trip.Bookings.Where(b => b.Status != "Anulowana").Sum(b => b.LiczbaUczestnikow),
                trip.AktualnaCena,
